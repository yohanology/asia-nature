        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <img src="/asia_nature_bureau_shenzhen_1.jpg" alt={t.alts.officeMeeting} loading="lazy" decoding="async" className="w-full h-auto shadow-xl rounded-sm grayscale hover:grayscale-0 transition-all duration-700" />
