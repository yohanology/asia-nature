            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-[#4A4A4A] leading-relaxed mb-6">
                  ...
                  <span className="font-semibold">sourcing industriel</span> et
                  la{' '}
                  <span className="font-semibold">
                    logistique internationale
                  </span>
                  , basée à{' '}
                  <span className="font-semibold">Shenzhen, en Chine</span>, au
                  cœur des réseaux de production asiatiques.
                </p>
                ...
                <p className="text-[#4A4A4A] leading-relaxed mb-8">
                  ...
                  industriel fiable et une capacité de livraison mondiale, Asia
                  Nature Limited s'est imposée comme un{' '}
                  <span className="font-semibold text-[#2F4F3E]">
